...
/**
 * DTO devuelto por la pasarela tras autenticar. Contiene los datos necesarios
...
public class UsuarioLoginResponseDTO {
	...
	public static UsuarioLoginResponseDTO fromEntity(Usuario usuario) {
		String roles = usuario.isAdministrador() ? "USUARIO,ADMINISTRADOR" : "USUARIO";
		return new UsuarioLoginResponseDTO(usuario.getId(), usuario.getEmail(), usuario.getNombre(),
				usuario.getApellidos(), roles);
	}
}