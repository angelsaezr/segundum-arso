...
public class PruebaRepositorio {
	...
	public static void main(String[] args) throws Exception {
		...
		// contexto.getBean(ServicioProductos.class);
		ServicioCategorias servicioCategorias = contexto.getBean(ServicioCategorias.class);

		/*
		 * System.out.println("----------- USUARIOS -----------\n");
		 * 
		 * // Configuración de datos del usuario String email = "juan2@um.es"; String
		 * nombre = "Juan"; String apellidos = "Perez Gomez";
		 * 
		 * // Alta del usuario System.out.println("Creando usuario..."); String id =
		 * servicioUsuarios.altaUsuario(email, nombre, apellidos);
		 ...
		 * 
		 * String idProd1 = servicioProductos.crear("Teclado mecánico",
		 * "Teclado switch azul con iluminación RGB", 45.90, EstadoProducto.COMO_NUEVO,
		 * true, idCategoria, id); System.out.println("Producto creado con id: " +
		 * idProd1);
		 * 
		 * String idProd2 = servicioProductos.crear("Monitor 27\" 144Hz",
		 * "Panel IPS 144Hz 1ms, HDR", 189.99, EstadoProducto.BUEN_ESTADO, false,
		 * idCategoria, id); System.out.println("Producto creado con id: " + idProd2);
		 * 
		 * String idProd3 = servicioProductos.crear("Portátil i7 16GB RAM",
		 * "Perfecto estado, batería cambiada recientemente", 650.00,
		 * EstadoProducto.NUEVO, true, idCategoria, id);
